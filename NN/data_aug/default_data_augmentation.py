...
from NN.data_aug.custom_transforms import Convert3DTo2DTransform, Convert2DTo3DTransform, \
    MaskTransform, ConvertSegmentationToRegionsTransform
from NN.data_aug.pyramid_augmentations import MoveSegAsOneHotToData, \
...
default_3D_augmentation_params = {
    ...
    "num_threads": 12 if 'tuframework_n_proc_DA' not in os.environ else int(os.environ['tuframework_n_proc_DA']),
